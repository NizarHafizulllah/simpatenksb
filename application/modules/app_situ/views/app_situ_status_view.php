              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="tidak ada" checked="true">
                      </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
             ...
             <div class="form-group p-10">
                    ...
                    <div class="col-md-3">
                    <?php if (!empty($file)) {?>
                      <a class="btn btn-primary form-control" target="_blank" href="<?php echo base_url('upload_file/situ/'.$file); ?>">Buka</a>  
