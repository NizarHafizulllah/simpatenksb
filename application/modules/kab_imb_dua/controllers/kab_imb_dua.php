...
class kab_imb_dua extends adminkab_controller {
	
	var $controller;
	public function kab_imb_dua(){
		parent::__construct();
		...
		$this->set_subtitle("IMB Diatas 250");
		$this->set_title("IMB Diatas 250");
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->update('imb_dua', $data); 
        if($res){
