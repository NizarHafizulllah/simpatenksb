...
class kab_irigasi extends adminkab_controller {
    
    var $controller;
    public function kab_irigasi(){
        parent::__construct();
        ...
        $this->set_subtitle("Surat Izin Jaringan Irigasi");
        $this->set_title("Surat Izin Jaringan Irigasi");
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->update('irigasi', $data); 
        if($res){
