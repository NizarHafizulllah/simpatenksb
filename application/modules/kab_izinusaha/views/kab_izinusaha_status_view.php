            ...
            <div class="panel-body">
              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <?php if ($fc_izin_praktek=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="fc_izin_praktek" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_izin_praktek" class="radio-blue" value="tidak ada" checked="true">
                      </div>
