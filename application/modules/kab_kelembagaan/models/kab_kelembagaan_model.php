...
class kab_kelembagaan_model extends CI_Model {


	function kab_kelembagaan_model(){
		parent::__construct();
	}
 ...
 function data($param)
	{		
		...
		// exit;
		 ...
		 $this->db->select('l.*, k.kecamatan as nm_kecamatan')->from("p3a l");
		 ...
		 if(!empty($no_register)) {
		 	$this->db->like("l.no_register",$no_register);
		 }
