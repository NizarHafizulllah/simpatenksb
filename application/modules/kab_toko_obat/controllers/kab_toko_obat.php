...
class kab_toko_obat extends adminkab_controller {
    
    var $controller;
    public function kab_toko_obat(){
        parent::__construct();
        ...
        $this->set_subtitle("Surat Izin Apotik dan Toko Obat");
        $this->set_title("Surat Izin Apotik dan Toko Obat");
