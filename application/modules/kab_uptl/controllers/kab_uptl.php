...
class kab_uptl extends adminkab_controller {
	
	var $controller;
	public function kab_uptl(){
		parent::__construct();
  ...
  //       exit();  
    ...
    function status(){
      ...
      //    exit();
        ...
        $this->set_subtitle("Status Izin UPTL ");
        $this->set_title("Status Izin UPTL ");
        $this->set_content($content);
        $this->cetak();
