            ...
            <div class="panel-body">
            	...
            	<div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($fk_ktp_pemohon=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="fk_ktp_pemohon" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_ktp_pemohon" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php if ($fk_sertifikat_tanah=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="fk_sertifikat_tanah" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_sertifikat_tanah" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php if ($fk_surat_peruntukan_tanah=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="fk_surat_peruntukan_tanah" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_surat_peruntukan_tanah" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_imb" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_imb" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                       ...
                       <?php if ($spt_keberatan_pemilik_tanah=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="spt_keberatan_pemilik_tanah" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="spt_keberatan_pemilik_tanah" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php if ($spt_keberatan_tetangga=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="spt_keberatan_tetangga" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="spt_keberatan_tetangga" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php if ($sp_gagguan_pencemaran=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="sp_gagguan_pencemaran" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="sp_gagguan_pencemaran" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($fk_storan_ho=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="fk_storan_ho" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_storan_ho" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($materai_6000=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="materai_6000" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="materai_6000" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($fk_situ=='ada') { ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_situ" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fk_situ" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($fc_npwp=='ada') { ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwp" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwp" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($berita_acara=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="berita_acara" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="berita_acara" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <?php if ($pas_photo=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="pas_photo" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="pas_photo" class="radio-blue" value="tidak ada" checked="true">
                      </div>
            ...
            <div class="panel-body">
            	...
            	<div class="form-group p-10">
                 ...
                 <div class="form-group p-10">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control tanggal" data-language='en' name="tgl_verifikasi" id="tgl_verifikasi" placeholder="Tanggal Verifikasi" value="<?php echo $tgl_verifikasi; ?>">
                    </div>
                  </div> 
