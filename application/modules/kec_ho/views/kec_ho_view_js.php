	 ...
	 var dt = $("#ho").DataTable(
		 	{
				...
				"processing": true,
		        "serverSide": true,
		        "ajax": '<?php echo site_url("kec_ho/get_data") ?>'
		 	});

		 
		 $("#ho_filter").css("display","none");  
...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA HO INI. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA  HO',
            draggable: true,
            buttons : [
              {
                label : 'YA',
