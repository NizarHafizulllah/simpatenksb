...
class kec_irigasi extends admin_controller {
    
    var $controller;
    public function kec_irigasi(){
        parent::__construct();
    ...
    function index(){
        ...
        $data_array['curPage'] = 'irigasi';

       

        $content = $this->load->view($this->controller."_view",$data_array,true);

        $this->set_subtitle("Izin Jaringan Irigasi");
        $this->set_title("Izin Jaringan Irigasi");
  ...
  //       exit();  
    ...
    function baru(){
       ...
       $this->set_subtitle("Tambah Izin Jaringan Irigasi");
        $this->set_title("Tambah Izin Jaringan Irigasi");
        $this->set_content($content);
        $this->cetak();
    }
    ...
    $post = $this->input->post();
       ...
       $this->load->library('form_validation');
        ...
        $this->form_validation->set_rules('no_telp','Syarat umum ketiga','required');
        $this->form_validation->set_rules('negara_pemohon','Syarat umum keempat','required');
        $this->form_validation->set_rules('alamat','Syarat umum kelima','required');
        $this->form_validation->set_rules('merk_usaha','Syarat umum keenam','required');
        $this->form_validation->set_rules('jenis_usaha','Syarat umum ketujuh','required');
        $this->form_validation->set_rules('alamat_usaha','Syarat umum kedelapan','required');
        ...
        $this->form_validation->set_rules('jenis_permohonan','Syarat teknis permohonan','required');
        $this->form_validation->set_rules('sp_materai','Tgl. Lahir Pemohon','required');
        $this->form_validation->set_rules('ktp','Tempat Lahir Pemohon','required');
        $this->form_validation->set_rules('rekom_desa','No. Telp. Pemohon','required');
        $this->form_validation->set_rules('dok_lingkungan','Pekerjaan Pemohon','required');
        $this->form_validation->set_rules('fc_akte','Pekerjaan Pemohon','required');
        $this->form_validation->set_rules('fc_npwpd','Pekerjaan Pemohon','required');
        $this->form_validation->set_rules('daftar_perusahaan','Pekerjaan Pemohon','required');
        $this->form_validation->set_rules('peta_lokasi','Pekerjaan Pemohon','required');
        $this->form_validation->set_rules('siup_asli','Pekerjaan Pemohon siup','required');
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->insert('irigasi', $post); 
        if($res){
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->update('irigasi', $post); 
        if($res){
   ...
   function editdata(){
      ...
      //    exit();
        ...
        $this->set_subtitle("Edit Izin Jaringan Irigasi");
        $this->set_title("Edit Izin Jaringan Irigasi");
        $this->set_content($content);
        $this->cetak();
        ...
        $res = $this->db->delete('irigasi', $data);
        if($res){
   ...
   function status(){
      ...
      //    exit();
        ...
        $this->set_subtitle("Status Izin Jaringan Irigasi");
        $this->set_title("Status Izin Jaringan Irigasi");
        $this->set_content($content);
        $this->cetak();
   ...
   $get = $this->input->get(); 
    ...
    $data['controller'] = get_class($this);
    $data['header'] = "Dokumen Izin Jaringan Irigasi";
    $data['query'] = $resx->row_array();
