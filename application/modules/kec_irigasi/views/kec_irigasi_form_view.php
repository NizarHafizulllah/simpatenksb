        ...
        <div class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group p-10">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" name="merk_usaha" id="merk_usaha" placeholder="Nama Usaha" value="<?php echo isset($merk_usaha)?$merk_usaha:''; ?>" >
                    </div>
                  </div>
              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" name="klasifikasi_usaha" id="klasifikasi_usaha" placeholder="Klasifikasi Perusahaan" value="<?php echo isset($klasifikasi_usaha)?$klasifikasi_usaha:''; ?>" >
                    </div>
                  </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">2. Fotocopy KTP</label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">3. Rekomendasi Lurah/ Kepala Desa setempat</label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">4. Pernyataan kesanggupan dari pemohon untuk memnuhi Dokumen Lingkungan </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="ada">
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="tidak ada">
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">5. Fotocopy Akte Kepemilikan Tanah</label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">6. Fotocopy NPWPD</label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="ada">
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="tidak ada">
                      </div>
                    </div>
                  </div> 

                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">7. Tanda daftar perusahaan </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="ada">
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="tidak ada">
                      </div>
                    </div>
                  </div> 

                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">8. Gambaran situasi/ peta lokasi</label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="ada">
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="tidak ada">
                      </div>
                    </div>
                  </div>      
            ...
            <div class="panel-body">
              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="ada" <?php if ($dok_lingkungan=='ada') { echo 'checked="true"'; } ?>>
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="tidak ada" <?php if ($dok_lingkungan=='tidak ada') { echo 'checked="true"'; } ?>>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="ada" <?php if ($fc_npwpd=='ada') { echo 'checked="true"'; } ?>>
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="tidak ada" <?php if ($fc_npwpd=='tidak ada') { echo 'checked="true"'; } ?>>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="ada" <?php if ($daftar_perusahaan=='ada') { echo 'checked="true"'; } ?>>
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="tidak ada" <?php if ($daftar_perusahaan=='tidak ada') { echo 'checked="true"'; } ?>>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="ada" <?php if ($peta_lokasi=='ada') { echo 'checked="true"'; } ?>>
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="tidak ada" <?php if ($peta_lokasi=='tidak ada') { echo 'checked="true"'; } ?>>
                      </div>
                    </div>
                  </div>      
