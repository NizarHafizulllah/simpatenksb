        ...
        <div class="panel">
            ...
            <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <?php if ($dok_lingkungan=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="dok_lingkungan" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="fc_npwpd" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <?php if ($daftar_perusahaan=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                    ...
                    <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="daftar_perusahaan" class="radio-blue" value="tidak ada" checked="true">
                      </div>
                  ...
                  <div class="form-group p-10">
                    ...
                    <div class="col-md-4">
                      <?php if ($peta_lokasi=='ada') { ?>
                      
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="ada" checked="true">
                      </div>
                      <div class="col-md-6">
                        &nbsp;
                      </div>
                      ...
                      <div class="col-md-6">
                        <input type="radio" name="peta_lokasi" class="radio-blue" value="tidak ada" checked="true">
                      </div>
