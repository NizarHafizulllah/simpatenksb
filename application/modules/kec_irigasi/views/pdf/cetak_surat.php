...
<table width="100%">
  <tr>
    ...
    <td width="2%">:</td>
    <td width="82%"><div align="justify" style="font-size: 9px;">Surat permohonan dari Saudara, tanggal <?php echo $d_surat.' Bulan '.$m_surat.' Tahun '.$y_surat; ?> yang bermaksud untuk memperoleh/mendaftar ulang/memperpanjang Surat Rekomendasi Izin Jaringan Irigasi;</div></td>
  </tr>
</table>
<br/>&nbsp;
<br/>&nbsp;
...
<table width="100%">
  <tr>
    ...
    <td width="2%">:</td>
    <td width="82%"><div align="justify" style="font-size: 9px;">bahwa permohonan tersebut diatas telah dilakukan pemeriksaan dan memenuhi syarat-syarat sesuai peraturan dan ketentuan yang berlaku, maka permohonan yang bersangkutan telah dapat diberikan Surat Rekomendasi Izin Jaringan Rekomendasi; </div> </td>
  </tr>
</table>
<br/>&nbsp;
<br/>&nbsp;
...
<table width="100%">
  ...
  <tr>
    ...
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['merk_usaha'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
