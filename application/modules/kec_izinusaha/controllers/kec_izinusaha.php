...
class kec_izinusaha extends admin_controller {
	
	var $controller;
	public function kec_izinusaha(){
		parent::__construct();
	...
	function index(){
		...
		$this->set_subtitle("Izin Usaha Praktek");
		$this->set_title("Izin Usaha Praktek");
  ...
  //       exit();  
    ...
    function baru(){
       ...
       $this->set_subtitle("Tambah Izin Usaha Praktek");
		$this->set_title("Tambah Izin Usaha Praktek");
		$this->set_content($content);
		$this->cetak();
    }
    ...
    // exit();
        ...
        $this->form_validation->set_rules('fc_izin_praktek','Pekerjaan Pemohon','required');
...
if($this->form_validation->run() == TRUE ) { 
   ...
   function editdata(){
      ...
      //    exit();
		...
		$this->set_subtitle("Edit Izin Usaha Praktek ");
		$this->set_title("Edit Izin Usaha Praktek ");
		$this->set_content($content);
		$this->cetak();
   ...
   function status(){
      ...
      //    exit();
		...
		$this->set_subtitle("Status Izin Usha Praktik ");
		$this->set_title("Status Izin Usha Praktik    ");
		$this->set_content($content);
		$this->cetak();
    ...
    $data['controller'] = get_class($this);
    $data['header'] = "Dokumen Persyaratan Izin Praktek";
    $data['query'] = $resx->row_array();
    ...
    $data['controller'] = get_class($this);
    $data['header'] = "Blanko Permohonan SIUP";
    $data['query'] = $resx->row_array();
