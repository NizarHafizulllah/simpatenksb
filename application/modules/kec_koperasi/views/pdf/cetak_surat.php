...
<table width="100%">
  <tr>
    ...
    <td width="2%">:</td>
    <td width="82%"><div align="justify" style="font-size: 9px;">Surat permohonan dari Saudara, tanggal <?php echo $d_surat.' Bulan '.$m_surat.' Tahun '.$y_surat; ?> yang bermaksud untuk memperoleh/mendaftar ulang/memperpanjang Surat Rekomendasi Izin Pendirian Koperasi;</div></td>
  </tr>
</table>
<br/>&nbsp;
<br/>&nbsp;
...
<table width="100%">
  <tr>
    ...
    <td width="2%">:</td>
    <td width="82%"><div align="justify" style="font-size: 9px;">bahwa permohonan tersebut diatas telah dilakukan pemeriksaan dan memenuhi syarat-syarat sesuai peraturan dan ketentuan yang berlaku, maka permohonan yang bersangkutan telah dapat diberikan Surat Rekomendasi Izin Pendirian Koperasi; </div> </td>
  </tr>
</table>
<br/>&nbsp;
<br/>&nbsp;
...
<table width="100%">
  <tr>
    ...
    <td width="82%" colspan="2"><div align="justif" style="font-size: 9px;"> Memberikan/memperpanjang Surat Rekomendasi Izin Pendirian Koperasi. kepada :   </div> </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['kewarganegaraan'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
    <td><div align="justif" style="font-size: 9px;"> No. KTP   </div> </td>
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['no_ktp'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['alamat_usaha'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
    <td><div align="justif" style="font-size: 9px;"> Merek Usaha   </div> </td>
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['merek_usaha'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
    <td><div align="justif" style="font-size: 9px;"> Klasifikasi Perushaan   </div> </td>
    <td><div align="justif" style="font-size: 9px;">: <?php echo $query['klasif_perusahaan'] ?></div></td>
  </tr>
  <tr>
    <td><div align="left" style="font-size: 9px;">&nbsp;</div></td>
    <td>&nbsp;</td>
