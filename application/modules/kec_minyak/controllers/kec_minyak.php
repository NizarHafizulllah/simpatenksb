...
class kec_minyak extends admin_controller {
    
    var $controller;
    public function kec_minyak(){
        parent::__construct();
  ...
  //       exit();  
    ...
    function baru(){
       ...
       $this->set_subtitle("Tambah Izin Depo Pangkalan Minyak");
        $this->set_title("Tambah Izin Depo Pangkalan Minyak");
        $this->set_content($content);
        $this->cetak();
    }
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->insert('minyak', $post); 
        if($res){
...
if($this->form_validation->run() == TRUE ) { 
        ...
        $res = $this->db->update('minyak', $post); 
        if($res){
   ...
   function editdata(){
         ...
         $this->db->where('id',$id);
         $izin_praktek = $this->db->get('minyak');
      ...
      //    exit();
        ...
        $this->set_subtitle("Edit Izin Depo Pangkalan Minyak");
        $this->set_title("Edit Izin Depo Pangkalan Minyak");
        $this->set_content($content);
        $this->cetak();
        ...
        $res = $this->db->delete('minyak', $data);
        if($res){
   ...
   function status(){
         ...
         $this->db->where('id',$id);
         $minyak = $this->db->get('minyak');
         $data_array = $minyak->row_array();
    ...
    $data['header'] = "Dokumen Persyaratan Izin Depo Pangkalan Minyak";
