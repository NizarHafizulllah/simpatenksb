        ...
        <div class="panel">
            ...
            <div class="panel-body">
            	...
            	<div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">2.  Fotokopi KTP ( 1 (satu) lembar) </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">3. Fotocopy Tanda Bukti Hak Atas Tanah     </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">4. Surat Pengantar dari kelurahan/desa   </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">8.  Rekomendasi dari Puskesmas </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">10. Fotocopy Surat Izin Usaha </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="ada">
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="tidak ada">
                      </div>
                    </div>
                  </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group p-10">
                  ...
                  <div class="form-group p-10">
                    <label class="col-md-8" for="text">10. Fotocopy Surat Izin Usahaan </label>
                    <div class="col-md-4">
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="ada" <?php if ($fc_siu=='ada') { echo 'checked="true"'; } ?>>
                      </div>
                      <div class="col-md-6">
                        <input type="radio" name="fc_siu" class="radio-blue" value="tidak ada" <?php if ($fc_siu=='tidak ada') { echo 'checked="true"'; } ?>>
                      </div>
                    </div>
                  </div>
