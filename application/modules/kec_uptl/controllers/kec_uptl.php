...
class kec_uptl extends admin_controller {
    
    var $controller;
    public function kec_uptl(){
        parent::__construct();
    ...
    function index(){
        ...
        $data_array['curPage'] = 'uptl';

       

        $content = $this->load->view($this->controller."_view",$data_array,true);

        $this->set_subtitle("Izin Usaha UPTL ");
        $this->set_title("Izin Usaha  UPTL");
  ...
  //       exit();  
    ...
    function baru(){
       ...
       $this->set_subtitle("Tambah Izin Usaha UPTL");
        $this->set_title("Tambah Izin Usaha UPTL");
        $this->set_content($content);
        $this->cetak();
    }
...
if($this->form_validation->run() == TRUE ) { 
   ...
   function editdata(){
         ...
         $this->db->where('id',$id);
         $uptl = $this->db->get('uptl');
         $data_array = $uptl->row_array();
      ...
      //    exit();
        ...
        $this->set_subtitle("Edit Izin Usaha UPTL ");
        $this->set_title("Edit Izin Usaha UPTL ");
        $this->set_content($content);
        $this->cetak();
