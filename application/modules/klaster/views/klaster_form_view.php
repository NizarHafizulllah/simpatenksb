  ...
  <link href="<?php echo base_url("assets") ?>/plugins/select2/select2.min.css" rel="stylesheet" >
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        ...
        <input type="text" name="klaster"  value="<?php echo isset($klaster)?$klaster:""; ?>" id="klaster" class="form-control input-style" placeholder="klaster . . ."  style="border-radius: 8px;">
      </div>
    </div>
