        ...
        <!-- Content Header (Page header) -->
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="<?php echo site_url("$this->controller/baru"); ?>"><button type="button" class="btn btn-primary form-control"><i class="fa fa fa-plus-circle "></i> Tambah Pekerjaan</button></a>
              </div>
            </div>
            <div class="box-body">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input id="pekerjaan" name="pekerjaan" type="text" class="form-control" placeholder="Pekerjaan" style="border-radius: 8px;">
              </div>
            </div>
            <div class="col-md-1">
              <div class="form-group">
