        ...
        <!-- Content Header (Page header) -->
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="<?php echo site_url("$this->controller/baru"); ?>"><button type="button" class="btn btn-primary form-control"><i class="fa fa fa-plus-circle "></i> Tambah Pengguna</button></a>
              </div>
            </div>
            <div class="box-body">
