...
class toko_obat extends admin_controller {
    ...
    function index(){
        ...
        $this->set_subtitle("Izin Apotik dan Toko Obat");
        $this->set_title("Izin Apotik dan Toko Obat");
...
if($this->form_validation->run() == TRUE ) { 
  ...
  $data_array['arr_klasifikasi'] = $this->cm->arr_dropdown3("klasifikasi_usaha", "id", "klasifikasi", "klasifikasi", "id_kecamatan", $userdata['id_kecamatan']);
      ...
      //    exit();
        ...
        $this->set_subtitle("Edit Izin Apotik dan Toko Obat");
        $this->set_title("Edit Izin Apotik dan Toko Obat");
        $this->set_content($content);
        $this->cetak();
        ...
        $res = $this->db->delete('toko_obat', $data);
        if($res){
   ...
   function status(){
         ...
         $this->db->where('id',$id);
         $toko_obat = $this->db->get('toko_obat');
         $data_array = $toko_obat->row_array();
    ...
    $data['header'] = "Dokumen Persyaratan Izin Apotik dan Toko Obat";
