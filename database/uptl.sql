...
--
-- Table structure for table `uptl`
--

CREATE TABLE IF NOT EXISTS `uptl` (
  `id` char(32) NOT NULL,
...
--
-- Dumping data for table `uptl`
--

INSERT INTO `uptl` (`id`, `nama_pemohon`, `tempat_lahir`, `tgl_lahir`, `pekerjaan`, `alamat`, `no_telp`, `nama_usaha`, `jenis_usaha`, `ukuran_luas_usaha`, `lokasi_usaha`, `status_bangunan_tempat_usaha`, `npwpd`, `negara_pemohon`, `nik_pemohon`, `klasifikasi_usaha`, `tgl_register`, `no_register`, `jenis_permohonan`, `ktp`, `fc_hak_tanah`, `sp_desa`, `sp_materai`, `denah_lokasi`, `foto`, `fc_pbb`, `rekom_uptd`, `gambar_bangunan`, `instalasi_air`, `rekom_desa`, `siup_asli`, `tgl_verifikasi`, `nama_petugas_verifikasi`, `kecamatan`, `kabupaten`, `nama_camat`, `nip_camat`, `status`, `retribusi_perthn_f`) VALUES
('0f2326e9feff4f6581548193e34796ca', 'Jannatun Aulia', 'Rumah Sakit', '1995-10-15', 'mahasiswi', 'jln rambutan', '085338283957', 'Tukang Pukul', 'jasa', '300 m', 'jln Kerato', 'baru', 'jkshfaa', 'indonesia', '775253628176837', 'yunkid', '2017-09-06', '82972646', 'baru', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', 'ada', '2017-09-07', 'nizar', '52_7_1', '52_7', 'Nizar Hafizullah', '7346726347236', 2, 3000000);
